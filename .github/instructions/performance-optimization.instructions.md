...
- **Understand the Platform:** Know the performance characteristics of your language, framework, and runtime. What's fast in  may be slow in JavaScript, and vice versa.
...
### Example 3: Caching Expensive Computation in 
```
...
### Example 6: Profiling a  Function
```
import cProfile
import pstats
...
- [ Performance Tips](https://docs..org/3/library/profile.html)
